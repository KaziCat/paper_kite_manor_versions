...
public class SporeBottlingProcedure {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.GLASS_BOTTLE) {
			{
				...
				BlockState _bs = PapercraftMagicDecorationModBlocks.SPORES_COLLECTION_PLATE.get().defaultBlockState();
			...
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(PapercraftMagicDecorationModItems.BOTTLE_VITALITY_SPORES.get());
