...
public class TakeTheSalmonProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		{
			BlockPos _bp = BlockPos.containing(x, y, z);
			BlockState _bs = PapercraftMagicDecorationModBlocks.SALMON_TRAY.get().defaultBlockState();
		...
		if (entity instanceof Player _player) {
			ItemStack _setstack = new ItemStack(PapercraftMagicDecorationModItems.CHUNKY_SMOKED_SALMON.get());
