...
public class PlaceTheGoldMedalCoffeeProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (world.isEmptyBlock(BlockPos.containing(x, y + 1, z))) {
			world.setBlock(BlockPos.containing(x, y + 1, z), PapercraftMagicDecorationModBlocks.GOLD_MEDAL_COFFEE_BLOCK.get().defaultBlockState(), 3);
			...
			if (!(new Object() {
				...
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(PapercraftMagicDecorationModItems.GOLD_MEDAL_COFFEE.get());
