...
public class PlaceTheLandNo1Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Direction direction, Entity entity) {
		if (direction == null || entity == null)
			return;
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == PapercraftMagicDecorationModBlocks.A_GLASS_OF_LAND_NO_1_BLOCK.get()) {
			world.setBlock(BlockPos.containing(x, y, z), PapercraftMagicDecorationModBlocks.PAIR_OF_LAND_NO_1_BY_THE_GLASS.get().defaultBlockState(), 3);
			{
				Direction _dir = (direction.getClockWise(Direction.Axis.Y));
			...
			if (world.isEmptyBlock(BlockPos.containing(x, y + 1, z))) {
				world.setBlock(BlockPos.containing(x, y + 1, z), PapercraftMagicDecorationModBlocks.A_GLASS_OF_LAND_NO_1_BLOCK.get().defaultBlockState(), 3);
				...
				if (!(new Object() {
					...
					if (entity instanceof Player _player) {
						ItemStack _stktoremove = new ItemStack(PapercraftMagicDecorationModItems.A_GLASS_OF_LAND_NO_1.get());
