...
public class PlaceTheNocturnalCatCoffeeProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (world.isEmptyBlock(BlockPos.containing(x, y + 1, z))) {
			world.setBlock(BlockPos.containing(x, y + 1, z), PapercraftMagicDecorationModBlocks.NOCTURNAL_CAT_COFFEE_BLOCK.get().defaultBlockState(), 3);
			...
			if (!(new Object() {
				...
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(PapercraftMagicDecorationModItems.NOCTURNAL_CAT_COFFEE.get());
