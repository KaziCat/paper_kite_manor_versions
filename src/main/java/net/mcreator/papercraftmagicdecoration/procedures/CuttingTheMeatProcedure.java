...
public class CuttingTheMeatProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		{
			BlockPos _bp = BlockPos.containing(x, y, z);
			BlockState _bs = PapercraftMagicDecorationModBlocks.STEAK_TRAY.get().defaultBlockState();
		...
		if (entity instanceof Player _player) {
			ItemStack _setstack = new ItemStack(PapercraftMagicDecorationModItems.LARGE_STEAKS.get());
