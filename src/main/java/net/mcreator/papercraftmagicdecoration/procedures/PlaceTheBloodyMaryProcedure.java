...
public class PlaceTheBloodyMaryProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (world.isEmptyBlock(BlockPos.containing(x, y + 1, z))) {
			...
			world.setBlock(BlockPos.containing(x, y + 1, z), PapercraftMagicDecorationModBlocks.BLOODY_MARY_BLOCK.get().defaultBlockState(), 3);
			{
