...
import net.mcreator.papercraftmagicdecoration.procedures.BlackCatLobbyBoyInteractivityProcedure;
...
public class BlackCatLobbyBoyEntity extends TamableAnimal implements RangedAttackMob, GeoEntity {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BlackCatLobbyBoyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BlackCatLobbyBoyEntity.class, EntityDataSerializers.STRING);
	...
	public BlackCatLobbyBoyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PapercraftMagicDecorationModEntities.BLACK_CAT_LOBBY_BOY.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "black_cat_lobby_boy");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new BlackCatLobbyBoyEntity.RangedAttackGoal(this, 1.25, 40, 10f) {
			@Override
	...
	public class RangedAttackGoal extends Goal {
		...
		public void stop() {
			...
			this.seeTime = 0;
			this.attackTime = -1;
			((BlackCatLobbyBoyEntity) rangedAttackMob).entityData.set(SHOOT, false);
		}
		...
		public void tick() {
			...
			if (--this.attackTime == 0) {
				...
				((BlackCatLobbyBoyEntity) rangedAttackMob).entityData.set(SHOOT, true);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Black Cat Lobby Boy");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(BlackCatLobbyBoyEntity.this.getId());
					return new LobbyBoyBackpackMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
		...
		BlackCatLobbyBoyInteractivityProcedure.execute(world, x, y, z, entity);
		return retval;
	}
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		FireWhiskeyThrowEntity.shoot(this, target);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		BlackCatLobbyBoyEntity retval = PapercraftMagicDecorationModEntities.BLACK_CAT_LOBBY_BOY.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(PapercraftMagicDecorationModEntities.BLACK_CAT_LOBBY_BOY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
