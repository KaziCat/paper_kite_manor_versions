...
public class AoaoEntity extends TamableAnimal implements RangedAttackMob, GeoEntity {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AoaoEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(AoaoEntity.class, EntityDataSerializers.STRING);
	...
	public AoaoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PapercraftMagicDecorationModEntities.AOAO.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "aoao");
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("papercraft_magic_decoration:aoao_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("papercraft_magic_decoration:aoao_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("papercraft_magic_decoration:aoao_death"));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AoaoEntity retval = PapercraftMagicDecorationModEntities.AOAO.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(PapercraftMagicDecorationModItems.FRIED_CHICKEN_LEG.get()).contains(stack.getItem());
	}
	...
	public static void init() {
		SpawnPlacements.register(PapercraftMagicDecorationModEntities.AOAO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
