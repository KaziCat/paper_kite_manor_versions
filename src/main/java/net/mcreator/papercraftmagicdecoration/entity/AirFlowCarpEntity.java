...
import net.mcreator.papercraftmagicdecoration.procedures.AirFlowCarpFlyProcedure;
...
public class AirFlowCarpEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(AirFlowCarpEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AirFlowCarpEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(AirFlowCarpEntity.class, EntityDataSerializers.STRING);
	...
	public AirFlowCarpEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PapercraftMagicDecorationModEntities.AIR_FLOW_CARP.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "air_flow_carp");
	}
	...
	public void baseTick() {
		super.baseTick();
		AirFlowCarpFlyProcedure.execute(this);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AirFlowCarpEntity retval = PapercraftMagicDecorationModEntities.AIR_FLOW_CARP.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(Items.MELON_SLICE).contains(stack.getItem());
	}
	...
	public static void init() {
		SpawnPlacements.register(PapercraftMagicDecorationModEntities.AIR_FLOW_CARP.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
