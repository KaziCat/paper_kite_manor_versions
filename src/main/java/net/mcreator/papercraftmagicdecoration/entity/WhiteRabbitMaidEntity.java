...
import net.mcreator.papercraftmagicdecoration.procedures.RabbitHealingProcedure;
...
public class WhiteRabbitMaidEntity extends TamableAnimal implements RangedAttackMob, GeoEntity {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(WhiteRabbitMaidEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(WhiteRabbitMaidEntity.class, EntityDataSerializers.STRING);
	...
	public WhiteRabbitMaidEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PapercraftMagicDecorationModEntities.WHITE_RABBIT_MAID.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "white_rabbit_maid");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new WhiteRabbitMaidEntity.RangedAttackGoal(this, 1.25, 40, 16f) {
			@Override
	...
	public class RangedAttackGoal extends Goal {
		...
		public void stop() {
			...
			this.seeTime = 0;
			this.attackTime = -1;
			((WhiteRabbitMaidEntity) rangedAttackMob).entityData.set(SHOOT, false);
		}
		...
		public void tick() {
			...
			if (--this.attackTime == 0) {
				...
				((WhiteRabbitMaidEntity) rangedAttackMob).entityData.set(SHOOT, true);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(PapercraftMagicDecorationModBlocks.FORGET_ME_NOT.get()));
	}
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("White Rabbit Maid");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(WhiteRabbitMaidEntity.this.getId());
					return new BunnySuitcaseMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public void playerTouch(Player sourceentity) {
		...
		RabbitHealingProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), sourceentity);
	}

	@Override
	public void performRangedAttack(LivingEntity target, float flval) {
		VodkaThrowEntity.shoot(this, target);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		WhiteRabbitMaidEntity retval = PapercraftMagicDecorationModEntities.WHITE_RABBIT_MAID.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(Items.COOKIE).contains(stack.getItem());
	}
	...
	public static void init() {
		SpawnPlacements.register(PapercraftMagicDecorationModEntities.WHITE_RABBIT_MAID.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
