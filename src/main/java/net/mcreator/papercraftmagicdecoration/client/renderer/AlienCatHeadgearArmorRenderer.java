...
import net.mcreator.papercraftmagicdecoration.item.model.AlienCatHeadgearModel;
import net.mcreator.papercraftmagicdecoration.item.AlienCatHeadgearItem;

public class AlienCatHeadgearArmorRenderer extends GeoArmorRenderer<AlienCatHeadgearItem> {
	public AlienCatHeadgearArmorRenderer() {
		super(new AlienCatHeadgearModel());
	...
	@Override
	public RenderType getRenderType(AlienCatHeadgearItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
