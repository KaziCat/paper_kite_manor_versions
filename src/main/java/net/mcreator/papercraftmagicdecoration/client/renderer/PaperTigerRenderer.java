...
import net.mcreator.papercraftmagicdecoration.entity.model.PaperTigerModel;
...
public class PaperTigerRenderer extends GeoEntityRenderer<PaperTigerEntity> {
	public PaperTigerRenderer(EntityRendererProvider.Context renderManager) {
		super(renderManager, new PaperTigerModel());
	...
	@Override
	public void preRender(PoseStack poseStack, PaperTigerEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
