...
import net.mcreator.papercraftmagicdecoration.entity.model.AirFlowCarpModel;
...
public class AirFlowCarpRenderer extends GeoEntityRenderer<AirFlowCarpEntity> {
	public AirFlowCarpRenderer(EntityRendererProvider.Context renderManager) {
		super(renderManager, new AirFlowCarpModel());
	...
	@Override
	public void preRender(PoseStack poseStack, AirFlowCarpEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
