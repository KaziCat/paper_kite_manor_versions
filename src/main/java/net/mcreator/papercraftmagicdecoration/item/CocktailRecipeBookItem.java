...
import net.mcreator.papercraftmagicdecoration.item.inventory.CocktailRecipeBookInventoryCapability;
...
public class CocktailRecipeBookItem extends Item {
	public CocktailRecipeBookItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Cocktail Recipe Book");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new CocktailRecipeBookUiMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new CocktailRecipeBookInventoryCapability();
	}
